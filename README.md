...
Beim ersten Start sollten die Datenbankmigrationen angewendet und die Einstellungen befüllt werden:
...
Anschließend unter `http://127.0.0.1:8000` die Einstellungen aufrufen und Firmendaten, Nummernkreise und E-Mail-Vorlagen einrichten.
